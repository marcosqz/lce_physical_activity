...
# This code takes the original images with the functions defining the levels of
# physical activity risk and reads them to extrapolate the coefficients defining
# the thresholds
